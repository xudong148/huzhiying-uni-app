...
export const dispatchRows = [
  { id: 'SO20260408001', type: '维修', area: '浦东新区', status: '抢单中', master: '待接单', amount: 88 },
  { id: 'SO20260408008', type: '安装', area: '徐汇区', status: '待上门', master: '张师傅', amount: 258 },
];

export const orderRows = [
  { id: 'SO20260408001', category: '空调维修', status: '待接单', user: '周女士', amount: 88 },
  { id: 'PO20260406018', category: '智能锁 Pro', status: '待发货', user: '林先生', amount: 1699 },
];

export const masterRows = [
  { name: '张师傅', skills: '空调 / 智能锁', score: 98, status: '在线', credit: 'A' },
  { name: '陈师傅', skills: '保洁 / 收纳', score: 92, status: '休息', credit: 'A-' },
];

export const pricingRows = [
  { category: '空调维修', basePrice: 58, guidePrice: '58-299', coefficient: '夜间 +30%' },
  { category: '智能锁安装', basePrice: 128, guidePrice: '128-388', coefficient: '假日 +20%' },
];

export const financeRows = [
  { billNo: 'SETTLE-001', type: '师傅结算', amount: 268, status: '待审核' },
...
export const systemRows = [
  { role: '超级管理员', scope: '全量菜单 / 审核 / 财务' },
  { role: '客服运营', scope: '订单 / 仲裁 / 内容' },
];
